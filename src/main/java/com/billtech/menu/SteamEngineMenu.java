...
public class SteamEngineMenu extends MachineMenuBase {
    ...
    public SteamEngineMenu(int id, Inventory inventory, SteamEngineBlockEntity be) {
        this(id, inventory, new SimpleContainer(1), be);
    }

    private SteamEngineMenu(int id, Inventory inventory, Container ghostContainer, SideConfigAccess access) {
        super(ModMenus.STEAM_ENGINE, id, access, EnumSet.of(TransportType.FLUID, TransportType.ENERGY));
        this.ghostContainer = ghostContainer;
        this.blockEntity = access instanceof SteamEngineBlockEntity engine ? engine : null;
